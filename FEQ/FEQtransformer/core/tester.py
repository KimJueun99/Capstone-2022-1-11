...
from .FEQT_utils import generate_arrays_from_file, picker
from .FEQT_utils import DataGeneratorTest, PreLoadGeneratorTest
...
class Performance:
    def __init__(self):
        self.D_tp, self.D_tn, self.D_fp, self.D_fn = 0
        self.P_tp, self.P_tn, self.P_fp, self.P_fn = 0
        self.S_tp, self.S_tn, self.S_fp, self.S_fn = 0

def model_load(input_hdf5=None,
           input_testset=None,
           input_model=None,
           output_name=None,
    ...
    return load_model(args['input_model'], custom_objects={'SeqSelfAttention': SeqSelfAttention, 
...
def tester(input_hdf5=None,
    ...
    for _ in range(int(np.ceil(len(test) / args['batch_size']))):
        ...
        if args['mode'].lower() == 'pre_load_generator':                
            ...
            for ts in range(pred_DD_mean.shape[0]): 
                ...
                if evi.split('_')[-1] == 'EV':
                    if len(matches) > 0:
                        if pick_errors[list(matches)[0]][0] and -50 < pick_errors[list(matches)[0]][0] < 50:
                            P_tp += 1
                        else:
                            P_fn += 1
                        if pick_errors[list(matches)[0]][1] and -50 < pick_errors[list(matches)[0]][1] < 50:
                            S_tp += 1
                        else:
                            S_fn += 1
                        D_tp += 1
                    ...
                    if len(matches) > 0:
                        D_fp += 1
                        if not matches[list(matches)[0]][3]:
                            P_tn += 1
                        else:
                            P_fp += 1

                        if not matches[list(matches)[0]][6]:
                            S_tn += 1
                        else:
                            S_fp += 1
                    else:
            ...
            for ts in range(pred_DD_mean.shape[0]): 
                ...
                if evi.split('_')[-1] == 'EV':
                    if len(matches) > 0:
                        if pick_errors[list(matches)[0]][0] is not None and -50 < pick_errors[list(matches)[0]][0] < 50:
                            P_tp += 1
                        else:
                            P_fn += 1
                        if pick_errors[list(matches)[0]][1] is not None and -50 < pick_errors[list(matches)[0]][1] < 50:
                            S_tp += 1
                        else:
                            S_fn += 1
                        D_tp += 1
                    ...
                    if len(matches) > 0:
                        D_fp += 1
                        if matches[list(matches)[0]][3] is None:
                            P_tn += 1
                        else:
                            P_fp += 1

                        if matches[list(matches)[0]][6] is None:
                            S_tn += 1
                        else:
                            S_fp += 1
                    else:
    ...
    with open(os.path.join(save_dir,'X_report.txt'), 'a') as the_file: 
        ...
        the_file.write('================== Performance ========================='+'\n')
        the_file.write('Detection TP, FP, FN, TN: {}, {}, {}, {}'.format(D_tp, D_fp, D_fn, D_tn) + '\n')
        the_file.write('Detection Precision, Recall, F1: {}, {}, {}'.format(*score(D_tp, D_fp, D_fn)) + '\n')
        the_file.write('P picking TP, FP, FN, TN: {}, {}, {}, {}'.format(P_tp, P_fp, P_fn, P_tn) + '\n')
        the_file.write('P picking Precision, Recall, F1: {}, {}, {}'.format(*score(P_tp, P_fp, P_fn)) + '\n')
        the_file.write('S picking TP, FP, FN, TN: {}, {}, {}, {}'.format(S_tp, S_fp, S_fn, S_tn) + '\n')
        the_file.write('S picking Precision, Recall, F1: {}, {}, {}'.format(*score(S_tp, S_fp, S_fn)) + '\n')
